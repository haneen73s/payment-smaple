...
public class CardFormTest {
    ...
    public void cardNumberIsShownIfRequired() {
        ...
        assertFieldsVisible(VISIBLE, GONE, GONE, GONE);
    }
    ...
    public void expirationIsShownIfRequired() {
        ...
        assertFieldsVisible(GONE, VISIBLE, GONE, GONE);
    }
    ...
    public void cvvIsShownIfRequired() {
        ...
        assertFieldsVisible(GONE, GONE, VISIBLE, GONE);
    }
    ...
    public void cardholderNameIsShownIfRequired() {
        ...
        assertFieldsVisible(GONE, GONE, GONE, VISIBLE);
    }
    ...
    public void repeatedCallsToSetupSetCorrectVisibility() {
        ...
        assertFieldsVisible(GONE, GONE, GONE, GONE);
        ...
        assertFieldsVisible(VISIBLE, VISIBLE, VISIBLE, VISIBLE);
    }
    ...
    public void setEnabledSetsStateCorrectly() {
        ...
        assertFieldsEnabled(true, true, true, true);

        mCardForm.setEnabled(false);
        assertFieldsEnabled(false, false, false, false);
    }
    ...
    public void validateSetsErrorOnFields() {
        ...
        assertFieldsError(false, false, false, false);

        mCardForm.validate();

        assertFieldsError(true, true, true, true);
    }
    ...
    private void assertFieldsEnabled(boolean cardNumberEnabled, boolean expirationEnabled,
                                     boolean cvvEnabled, boolean cardholderNameEnabled) {
